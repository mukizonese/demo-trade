...
@Slf4j
public class ZipFileCsvFlatFileItemReader<T> extends AbstractItemCountingItemStreamItemReader<T>
        implements ResourceAwareItemReaderItemStream<T>, InitializingBean {

    //private static final Log logger = LogFactory.getLog(ZipFileCsvFlatFileItemReader.class);
    ...
    public ZipFileCsvFlatFileItemReader() {
        setName(ClassUtils.getShortName(ZipFileCsvFlatFileItemReader.class));
    }
